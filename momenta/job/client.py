...
mydb = MySQLdb.connect(passwd=os.getenv('MOMENTA_MYSQL_PASSWD'), port=int(os.getenv('MOMENTA_MYSQL_PORT')),db="momenta",host=os.getenv('MOMENTA_MYSQL_HOST'),user=os.getenv('MOMENTA_MYSQL_USER'))
